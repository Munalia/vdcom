...
async def help_message_f(client, message):
    ...
    if UPDATES_CHANNEL is not None:
        try:
            ...
            if user.status == "kicked":
               await message.reply_text(
                   text="Sorry Sir, You are Banned to use me. Contact my [Owner](https://t.me/KumarSwamiKS).",
                   parse_mode="markdown",
            ...
            await message.reply_text(
                text="Something went Wrong. Contact my [Owner](https://t.me/KumarSwamiKS).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Updates Channel', url='https://t.me/KS_UpdatesChannel')
                ],
                [
